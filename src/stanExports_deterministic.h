...
namespace model_deterministic_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deterministic");
    reader.add_event(52, 50, "end", "model_deterministic");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_deterministic : public prob_grad {
private:
    int N;
    int K;
    int M;
    ...
    matrix_d trans_Y;
public:
    model_deterministic(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deterministic_namespace::model_deterministic";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(trans_theta, add(zeta,multiply(X,tau)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_deterministic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_deterministic_namespace::model_deterministic stan_model;
